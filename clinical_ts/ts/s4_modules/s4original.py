...
try: # Try CUDA extension
    ...
    log.warn(
        "CUDA extension for cauchy multiplication not found. Install by going to extensions/kernels/ and running `python setup.py install`. This should speed up end-to-end training by 10-50%"
    )
