...
def main():
    ...
    model_configs['lag'] = 900
    model_configs['horizon'] = 100
    print(model_configs["embedding_config"])
    print(model_configs["encoder_config"])
    print(model_configs["decoder_config"])
